...
import { addAccountSchema } from './add-account-modal.schema'
        ...
        <div class="w-full bg-white flex flex-col overflow-y-auto
          ...
          <form class="flex-1  px-6 lg:px-11  py-6 flex flex-col gap-6" @submit.prevent="onSubmit">
            ...
            <div class="hidden lg:flex gap-5">
              ...
              <!-- Right column -->
              <div class="flex-1 flex flex-col gap-5">
                <FormInput name="accountNumber" label="Número de cuenta" placeholder="Escribe tu cuenta destino" :formatter="digitsOnly" />
            ...
            <div class="flex lg:hidden flex-col gap-5">
              ...
              <FormInput name="accountNumber" label="Número de cuenta" placeholder="Escribe tu cuenta de destino" :formatter="digitsOnly" />
              <FormInput name="alias" label="Ponle nombre a tu cuenta" placeholder="Escribe un alias" />
              <FormCheckbox name="ownerConfirm">
