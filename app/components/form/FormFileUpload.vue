...
<template>
  <div class="w-full flex flex-col gap-2">
    ...
    <button type="button" class="flex flex-row items-center h-14 pl-7 pr-4 rounded-lg border bg-white transition-colors"
      :class="{
        'border-red': !!error,
      ...
      <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-gray-40 shrink-0" fill="none" viewBox="0 0 24 24"
        stroke="currentColor">
